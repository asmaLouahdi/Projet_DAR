$(document).ready(function() {
	...
	function menu(current){
		var listeMenu = ['li_actualite','li_allevents','li_events','li_myevents','li_publications','li_accessoires','li_comment','li_messages','li_aboutUs','li_updateprofile','li_notifications'];
