...
<body>
    ...
    <div class="breadcumb-area bg-img" style="background-image: url(../img/event.jpg);">
     ...
     <footer class="footer-area text-center">
    	...
    	<div id="myModal" class="modal">
			...
			<div class="modal-content">
				...
				<img id="photo" width="50" height="50"><input id="user_name" readonly>
				</div>
					<div>
						<input id="pop_message" class="champ_pop" name="content">
						<input type="hidden" name="action" value="contact">
						 <input type="hidden" id="user_id" name="contact_id" >
