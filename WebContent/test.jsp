			...
			<div class="top-menu">
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown  dropdown-inbox"
						id="test"><a href="javascript:;"
						class="dropdown-toggle" 
						data-hover="dropdown" data-close-others="false"> <i
							class="icon-envelope-open"></i> <span id="msg_count" class="badge badge-default">
								0 </span>
					</a>
						<ul class="">
						<!-- 	<li class="external" >
					...
					<li class="dropdown dropdown-user"><%!String name = null;%> <%
 	name = (String) request.getAttribute("name");
 %> 
<a href="javascript:;" class="dropdown-toggle"
						data-toggle="dropdown" data-hover="dropdown"
						data-close-others="true"> 
						<img id="ItemPreview" class="img-circle"  src="data:image/jpg;base64,<%=user.getAvatar().getBase64Image()%>" />
							 <span
							class="username username-hide-on-mobile"> <%=name%></span> <i
							class="fa fa-angle-down"></i>
					</a>
						<ul class="dropdown-menu dropdown-menu-default">
							<li  id="li_updateProfile"><a href="javascript:;"> <i class="icon-user"></i>
									My Profile
							</a></li>
							<li><a href="login.jsp"> <i class="icon-calendar"></i>Logout
							</a></li>
			...
			<div class="page-sidebar navbar-collapse collapse">
				...
				<ul class="page-sidebar-menu" data-keep-expanded="false"
					...
					<li id="li_comment"><a href="javascript:;"> <i
							class="icon-puzzle"></i> <span class="title">Tell
								Us about what do you think</span> <span></span>
					</a></li>
					...
					<div class="tab-content">
						<div class="tab-pane active page-quick-sidebar-chat"
							...
							<div class="page-quick-sidebar-item">
								<div class="page-quick-sidebar-chat-user"></div>
							</div>
						</div>
